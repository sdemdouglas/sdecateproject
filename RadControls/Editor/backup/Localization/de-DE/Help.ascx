...
<table cellspacing="0" cellpadding="2" border="1" bordercolor="#000000" style="font:normal 10px Arial">
	...
	<tr>
		...
		<td>Entwurfsansicht - Schaltet r.a.d.editor in die Entwurfsansicht.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Img/ButtonHtml.gif"></td>
		<td>HTML-Ansicht - Schaltet r.a.d.editor in die HTML-Ansicht.</td>
		<td>-</td>
	</tr>
	<tr>
		<td align="middle"><img src="<%= this.SkinPath %>Img/ButtonPreview.gif"></td>
		<td>Vorschau - Schaltet r.a.d.editor in den Vorschaumodus.</td>
		<td>-</td>
	</tr>
	...
	<tr>
		...
		<td>Ansicht umschalten - Schaltet r.a.d.editor in den Vollbildmodus.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Drucken - Druckt den Inhalt des r.a.d.editors oder der gesamten Internetseite.</td>
		<td>Ctrl+P</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Text einfügen - Fügt Text (ohnen Formatierung) in den r.a.d.editor ein.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Info - Zeigt Informationen zur aktuellen Version von r.a.d.editor an.</td>
		<td>-</td>
	</tr>
	<tr>
