...
<table cellspacing="0" cellpadding="2" border="1" bordercolor="#000000" style="font:normal 10px Arial">
	...
	<tr>
		...
		<td>Bouton Mode Design - Passer r.a.d.<span>editor</span> en mode design.</td>
		<td>-</td>
	</tr>
	<tr>
		<td style="text-align: middle;"><img src="<%= this.SkinPath %>Img/ButtonHtml.gif"></td>
		<td>Bouton Mode HTML - Passer r.a.d.editor en mode HTML.</td>
		<td>-</td>
	</tr>
	<tr>
		<td style="text-align: middle;"><img src="<%= this.SkinPath %>Img/ButtonPreview.gif"></td>
		<td>Bouton Mode Prévisualisation - Passer r.a.d.editor en mode prévisualisation.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Bouton de changement du mode d'affichage - Passe r.a.d.editor en mode plein écran.</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Bouton Impression - Imprime le contenu du r.a.d.editor ou de la page Web entière.</td>
		<td>Ctrl+P</td>
	</tr>
	<tr>
