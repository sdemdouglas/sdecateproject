...
namespace BLL
{
    public class scs_error_dictionary
    {
        ...
        */
        public virtual void AddNew()
        {
            if (dataTable.Rows.Count == 0)
            {
                ...
                cmd.CommandText = "SELECT * FROM [scs_error_dictionary] WHERE 1=0";
        ...
        */
        public virtual bool LoadAll()
        {
            ...
            SqlDataAdapter dataAdapter = new SqlDataAdapter("[pr_scs_error_dictionary_LoadAll]", this.ConnectionString);
            dataAdapter.Fill(dataTable);
        ...
        '=================================================================
        */
        public virtual bool LoadByPrimaryKey(string Key_error_id)
        {
            bool loaded = false;
            ...
            cmd.CommandText = "[pr_scs_error_dictionary_Sel]";

            SqlParameter p;

            p = Parameters.Key_error_id;
            p.Value = Key_error_id;
        ...
        */
        ...
        protected class Parameters
        {
            ...
            public static SqlParameter Key_error_id
            {
                get
                {
                    return new SqlParameter("@Key_error_id", SqlDbType.VarChar, 20);
                }
            }

            public static SqlParameter Txt_error_desc
            {
                get
                {
                    return new SqlParameter("@Txt_error_desc", SqlDbType.VarChar, 250);
                }
            }

            public static SqlParameter Txt_message
            {
                get
                {
                    return new SqlParameter("@Txt_message", SqlDbType.Text, 2147483647);
                }
            }
        ...
        {
            public const string Key_error_id = "Key_error_id";
            public const string Txt_error_desc = "Txt_error_desc";
        ...
        public virtual string Key_error_id
        {
            get
            {
                return (string)currentRow[ColumnNames.Key_error_id];
            }

            set
            {
                currentRow[ColumnNames.Key_error_id] = value;
            }
        }

        public virtual string Txt_error_desc
        {
            get
            {
                return (string)currentRow[ColumnNames.Txt_error_desc];
            }

            set
            {
                currentRow[ColumnNames.Txt_error_desc] = value;
            }
        }

        public virtual string Txt_message
        {
            get
            {
                return (string)currentRow[ColumnNames.Txt_message];
            }

            set
            {
                currentRow[ColumnNames.Txt_message] = value;
            }
        }
        ...
        protected SqlCommand CreateInsertCommand()
        {
            ...
            cmd.CommandText = "[pr_scs_error_dictionary_Insert]";
        ...
        protected SqlCommand CreateUpdateCommand()
        {
            ...
            SqlCommand cmd = CreateParameters();
            cmd.CommandText = "[pr_scs_error_dictionary_Update]";
        ...
        protected SqlCommand CreateDeleteCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[pr_scs_error_dictionary_Delete]";
        ...
        protected SqlCommand CreateParameters()
        {
            ...
            p = cmd.Parameters.Add(Parameters.Key_error_id);
            p.SourceColumn = "Key_error_id";
            p.SourceVersion = DataRowVersion.Current;

            p = cmd.Parameters.Add(Parameters.Txt_error_desc);
            p.SourceColumn = "Txt_error_desc";
            p.SourceVersion = DataRowVersion.Current;

            p = cmd.Parameters.Add(Parameters.Txt_message);
            p.SourceColumn = "Txt_message";
            p.SourceVersion = DataRowVersion.Current;
