...
/// <summary>
/// Summary description for scs_narrative
/// </summary>
namespace BLL
{
    public class scs_narrative
    {
        ...
        */
        public virtual void AddNew()
        {
            if (dataTable.Rows.Count == 0)
            {
                ...
                cmd.CommandText = "SELECT * FROM [scs_narrative] WHERE 1=0";
        ...
        */
        public virtual bool LoadAll()
        {
            ...
            SqlDataAdapter dataAdapter = new SqlDataAdapter("[pr_scs_narrative_LoadAll]", this.ConnectionString);
            dataAdapter.Fill(dataTable);
        ...
        '=================================================================
        */
        public virtual bool LoadByPrimaryKey(int Key_narrative_id)
        {
            bool loaded = false;
            ...
            cmd.CommandText = "[pr_scs_narrative_LoadByPrimaryKey]";

            SqlParameter p;

            p = Parameters.Key_narrative_id;
            p.Value = Key_narrative_id;
        ...
        */
        ...
        protected class Parameters
        {
            ...
            public static SqlParameter Txt_narrative_section_title
            {
                get
                {
                    return new SqlParameter("@Txt_narrative_section_title", SqlDbType.VarChar, 100);
                }
            }

            public static SqlParameter Txt_narrative_desc
            {
                get
                {
                    return new SqlParameter("@Txt_narrative_desc", SqlDbType.VarChar, 2000);
                }
            }

            public static SqlParameter Flg_optional
            {
                get
                {
                    return new SqlParameter("@Flg_optional", SqlDbType.Bit, 0);
                }
            }
        ...
        public class ColumnNames
        {
            ...
            public const string Txt_narrative_section_title = "Txt_narrative_section_title";
            public const string Txt_narrative_desc = "Txt_narrative_desc";
            public const string Flg_optional = "Flg_optional";
        ...
        public virtual string Txt_narrative_section_title
        {
            get
            {
                return (string)currentRow[ColumnNames.Txt_narrative_section_title];
            }

            set
            {
                currentRow[ColumnNames.Txt_narrative_section_title] = value;
            }
        }

        public virtual string Txt_narrative_desc
        {
            get
            {
                return (string)currentRow[ColumnNames.Txt_narrative_desc];
            }

            set
            {
                currentRow[ColumnNames.Txt_narrative_desc] = value;
            }
        }

        public virtual bool Flg_optional
        {
            get
            {
                return (bool)currentRow[ColumnNames.Flg_optional];
            }

            set
            {
                currentRow[ColumnNames.Flg_optional] = value;
            }
        }
        ...
        protected SqlCommand CreateInsertCommand()
        {
            ...
            cmd.CommandText = "[pr_scs_narrative_Insert]";


            cmd.Parameters["@Key_narrative_id"].Direction = ParameterDirection.Output;
        ...
        protected SqlCommand CreateUpdateCommand()
        {
            ...
            SqlCommand cmd = CreateParameters();
            cmd.CommandText = "[pr_scs_narrative_Update]";
        ...
        protected SqlCommand CreateDeleteCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[pr_scs_narrative_Delete]";
        ...
        protected SqlCommand CreateParameters()
        {
            ...
            p = cmd.Parameters.Add(Parameters.Txt_narrative_section_title);
            p.SourceColumn = "Txt_narrative_section_title";
            p.SourceVersion = DataRowVersion.Current;

            p = cmd.Parameters.Add(Parameters.Txt_narrative_desc);
            p.SourceColumn = "Txt_narrative_desc";
            p.SourceVersion = DataRowVersion.Current;

            p = cmd.Parameters.Add(Parameters.Flg_optional);
            p.SourceColumn = "Flg_optional";
            p.SourceVersion = DataRowVersion.Current;
