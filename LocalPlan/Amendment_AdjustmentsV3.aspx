<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Amendment_AdjustmentsV3.aspx.cs" Inherits="LocalPlan_Amendment_AdjustmentsV2_V" %>
...
<body >
    ...
    function Close(keyactiveid)    
     {  
          try
          {  
            GetRadWindow().BrowserWindow.refreshGrid("LocalPlan_Amendments",keyactiveid);
            //mainWdocument.location =   'Amendments.aspx?keyactiveid=' + keyactiveid + "&notfinished=" + finishedStatus;
...
<radTS:Tab runat="server" Text="Line Item Transfer" PageViewID="Page4" ID="tabLineItems" Enabled="False" Value="Page4"></radTS:Tab>
    ...
    <radTS:RadMultiPage ID="multipageWizard" runat="server" SelectedIndex="0" Width="100%">
        <radTS:PageView ID="Page0" runat="server"><table width="100%">
            <tr>
                <td colspan="1" style="width: 123px; text-align: left; height: 22px;">
                    &nbsp;Amendment Type
                </td>
                <td colspan="3" style="height: 22px" align="left">
                    <asp:DropDownList ID="ddAmendmentReason" runat="server" DataSourceID="sqlDsAmendmentReason"
                        ...
                        Width="515px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" onChange="allowpostback();" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddAmendmentReason"
        ...
        <td colspan="3">
            ...
            <tr >
                <td colspan="1" style="width: 123px; text-align: right">
                    <span></span>
                </td>
                <td colspan="3">
                    </td>
            ...
            <tr>
                <td colspan="1" style="width: 123px; height: 18px;">
                </td>
            ...
            <table style="width: 724px; text-align: left;">
                ...
                <tr style="font-size: 9pt">
                    ...
                    <td colspan="3">
                        ...
                        <asp:Label ID="lbl_MustPickDestination" runat="server" ForeColor="Red" Text="** Fund Destination Required" Visible="False"></asp:Label></td>
                </tr>
                <tr style="font-size: 9pt">
...
<ItemStyle Width="0.8in"></ItemStyle>
        ...
        <tr>
            <td align="right">
                ...
                <asp:Button ID="Button4" runat="server" Text="Cancel" OnClick="Button3_Click1" style="position: relative" OnClientClick="allowpostback_CancelButton();" Width="100px" CausesValidation="False" /></td>
        </tr>
        <tr>
...
<Windows>
    ...
    <br />
    &nbsp;<asp:HiddenField ID="hfRoleId" runat="server" /><asp:HiddenField ID="hf_Act_id" runat="server" />
    <br />
    <br />
    <br />
