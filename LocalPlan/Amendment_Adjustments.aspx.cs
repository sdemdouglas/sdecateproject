...
public partial class LocalPlan_Amendment_Adjustments : System.Web.UI.Page
{
    //Keep track of activityid and headerTrans by using Textbox 
 //   private static int keyactivityid;
 //   private static int header_transid ;
  //  Boolean anupdate = false;
    ...
    protected override void OnPreRenderComplete(EventArgs e)
    {
        ...
        try
        {
            ...
            HDN_PlanID.Value = Session[Session.SessionID + "PlanId"].ToString();
        }
        catch
        {
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session[Session.SessionID + "roleid"].ToString() != "102" && Session[Session.SessionID + "roleid"].ToString() != "103" && Session[Session.SessionID + "roleid"].ToString() != "101")
        {
...
/* End Section to test if Transfer should happen  RL 10-182008  */
   ...
   //     header_transid = Convert.ToInt32(e.Command.Parameters["@l_header_activity_id"].Value);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        SQLRL_act_transtatusupdate.UpdateParameters.Add("key_activity_id", txtActid.Text);
        SQLRL_act_transtatusupdate.Update();
        hdn_KeyActivityID.Value = "-1";
        hdn_finishedStatus.Value = "true";
        Session[Session.SessionID + "finishstat"] = "true";
       
        Session[Session.SessionID + "keyactiveID"] = "-1";
        ////////////////////////////////////////////////////////////
        if (Convert.ToInt32(ddAmendmentReason.SelectedValue) == 102)
        {
            SqlDSRL_pr_activitiy_SRC_OF_Fun.UpdateParameters.Clear();
            ...
            if (Convert.ToInt32(ddAmendmentReason.SelectedValue) == 102)
                ...
                SqlDSRL_pr_activitiy_SRC_OF_Fun.UpdateParameters.Add("key_fund_source_id", DLB_FunCode.SelectedValue.ToString());
        ...
        InjectScript.Text = "<script type='text/javascript'>Close('" + txtActid.Text + "')</" + "script>";  
    ...
    protected void Button3_Click1(object sender, EventArgs e)
    {
        ...
        SQLRL_act_transtatusupdate.DeleteParameters.Add("key_activity_id", txtActid.Text);
