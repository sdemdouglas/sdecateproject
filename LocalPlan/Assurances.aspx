...
<asp:Content ID="Content1" ContentPlaceHolderID="mainCopy" Runat="Server">
    <script type="text/javascript">
       ...
       //  alert(fiscalyear.value);
            window.open("../Reports/ViewReport.aspx?type=FiscalAssurances&planid=" + PID + "&format=" + format + "&FiscalYear=" +fiscalyear.value,"ReportsWindow");
        }
    </script>
    <table width="100%">
        <tr>
            ...
            <td align="center" colspan="3" style="text-align: left; width: 632px;">
                <asp:CheckBox ID="cbAccepted" runat="server"
                    Text="I agree to all the assurances" />&nbsp;
                            ...
                            <asp:Button ID="btnPrint" runat="server" Text="Print PDF" Width="100px" OnClientClick="javascript:Print('pdf')" Visible="False" />
                <asp:Button ID="btn_Print_Word" runat="server" Text="Print Word" Width="100px" OnClientClick="javascript:Print('AWDOCX')" Visible="False" />
        
        <input id="Button1" type="button" value="Print PDF"  OnClick="javascript:Print('pdf')" style="width: 100px; height: 27px;" />
        <input id="Button2" type="button" value="Print Word" OnClick="javascript:Print('AWDOCX')" style="width: 100px; height: 28px;" />
        </td>
        </tr>
