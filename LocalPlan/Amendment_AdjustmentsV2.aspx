<%@ Page Language="C#" MasterPageFile="~/AppMaster.master" AutoEventWireup="true" CodeFile="Amendment_AdjustmentsV2.aspx.cs" Inherits="LocalPlan_Amendment_AdjustmentsV2_V" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainCopy" Runat="Server">
    ...
    function Close(keyactiveid)    
     {  
          try
          {
          window.location =   'Amendments.aspx?keyactiveid=' + keyactiveid + "&notfinished=" +            finishedStatus;
          }
          catch (err)
          {
          }
    ...
    try
    {
        var validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator1');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator2');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator3');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator4');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator5');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator6');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator7');
        ValidatorEnable(document.all(validation_obj), false);
         validation_obj =  document.getElementById('ctl00_mainCopy_RequiredFieldValidator8');
        ValidatorEnable(document.all(validation_obj), false);
...
try
{
        var tableElement =  document.getElementById('ctl00_mainCopy_GridView1');
        var a = 1;
      
        for (var i=2;i<=tableElement.rows.length;i++)
        {
           var currentRow_TextBox = 'ctl00_mainCopy_GridView1_ctl0' + i + '_TextBox5';
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            var tot = document.getElementById('ctl00_mainCopy_txt_tot2transfer');
        ...
        for (var i=2;i<=tableElement.rows.length;i++)        
            {
                ...
                var currentRow_RadioButton = 'ctl00_mainCopy_GridView1_ctl0' + i + '_RadioButton1';
                var currentRow_TextBox = 'ctl00_mainCopy_GridView1_ctl0' + i + '_TextBox5';
...
function MasterMath()
{
    try
    {
        ...
        var tableElement =  document.getElementById('ctl00_mainCopy_GridView2');

        var tot = document.getElementById('ctl00_mainCopy_txt_tot2transfer');
        var transbutton = document.getElementById('ctl00_mainCopy_Button1');
        var a = 1;
        var total = 0;

        for (var i=2;i<=tableElement.rows.length;i++)
        {
            var currentRow_TextBox = 'ctl00_mainCopy_GridView2_ctl0' + i +'_TextBox5';
            var txtbox =  document.getElementById(currentRow_TextBox);
    ...
    function showerrors(errorid)
    {
     var winobj = window.radopen("Transfer_ValidationErrors.aspx?id=" + errorid, "MainPop");
        ...
        function calCharNumber1()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain1_txtCharCount").value = (remCharlength - des.length);           
        }
        ...
        function calCharNumber_txtCoreIndicatorsDesc()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain2_txtCharCount").value = (remCharlength - des.length);           
        }
        ...
        function calCharNumber_txtReductionFundsDesc()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain3_txtCharCount").value = (remCharlength - des.length);           
        }
        ...
        function calCharNumber_txtAmdChangeInFundsDesc()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain4_txtCharCount").value = (remCharlength - des.length);           
        }
        ...
        function calCharNumber_txtAmdCoreIndicatorsDesc()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain5_txtCharCount").value = (remCharlength - des.length);           
        }
        ...
        function calCharNumber_txtAmdReductionDesc()
        {
            ...
            document.getElementById("ctl00_mainCopy_CountCharRemain6_txtCharCount").value = (remCharlength - des.length);           
        }
...
<div id="wz_adminDIV" style="vertical-align:top;"> 
        ...
        <asp:TextBox ID="txtActid"
            runat="server"></asp:TextBox><asp:TextBox ID="txtHeaderTrans" runat="server"></asp:TextBox><radW:RadWindowManager ID="RadWindowManager2" runat="server">
...
<radTS:Tab runat="server" Text="Line Item Transfer" PageViewID="Page4" ID="tabLineItems" Enabled="False" Value="Page4"></radTS:Tab>
    ...
    <radTS:RadMultiPage ID="multipageWizard" runat="server" SelectedIndex="0" Width="100%">
        <radTS:PageView ID="Page0" runat="server"><table width="100%">
            <tr>
                <td colspan="1" style="width: 137px; text-align: left; height: 22px;">
                    &nbsp;Amendment Type
                </td>
                <td colspan="3" style="height: 22px">
                    <asp:DropDownList ID="ddAmendmentReason" runat="server" DataSourceID="sqlDsAmendmentReason"
                        ...
                        Width="600px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" onChange="allowpostback();" AutoPostBack="True">
                    </asp:DropDownList></td>
    </tr><tr >
                ...
                <tr>
                    <td rowspan="3" style="height: 13px; text-align: left;">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Transfer Funds >>>>" Enabled="True" OnClick="Button1_Click" OnClientClick="MasterMath();"/>&nbsp;
                            ...
                            <tr>
                                <td colspan="3" rowspan="1" style="height: 3px; text-align: center"><asp:Button ID="Button2" runat="server" Text="Finish" Enabled="False" OnClick="Button2_Click" style="position: relative"  />
